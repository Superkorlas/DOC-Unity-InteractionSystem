...
SO assets are shared — they cannot store per-object state safely. If you need per-instance state (e.g., a "used" flag per chest), use [`InteractableActionSOWrapper`](/DOC-Unity-InteractionSystem/api/interactableactionsowrapper/) instead.
