...
<Aside type="tip">
Use [`InteractorBase`](/Unity-InteractionSystem/api/interactorbase/) as your starting point when implementing a custom interactor — it provides the full action management and event pipeline. Only implement `IInteractor` directly if you need a completely custom architecture.
</Aside>
...
See the [Event System guide](/Unity-InteractionSystem/guides/events/) for subscription examples.
