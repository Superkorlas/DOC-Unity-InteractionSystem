---
title: "IInteractable"
description: "Interface for objects that can be interacted with by the player. Implement this interface on any object that should support player interactions."
sidebar:
  label: "IInteractable"
---
