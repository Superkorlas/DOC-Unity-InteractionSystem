...
description: "Event arguments for when the selected action changes on an interactor. Contains information about the target, the new selected index, and the action."
sidebar:
