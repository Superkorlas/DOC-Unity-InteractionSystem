...
<Aside type="tip">
Extend this class to create a custom interactor (proximity, 2D, VR, click-to-interact…). You only need to set `currentTarget`, call `RaiseInteractionStarted()`, and call `EndInteraction()`. See the [Extending guide](/Unity-InteractionSystem/guides/extending/).
</Aside>
