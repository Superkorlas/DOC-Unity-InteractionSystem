...
description: "Represents the result of an executed interaction action. Contains a success flag and an optional message describing the outcome. This struct is serializable for logging and debugging purposes."
sidebar:
