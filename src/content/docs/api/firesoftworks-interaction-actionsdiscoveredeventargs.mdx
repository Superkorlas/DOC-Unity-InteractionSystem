...
description: "Event arguments passed when a new set of actions is discovered on an interactable target. This event fires when the player focuses on a new interactable object."
sidebar:
